...
import org.rgs.ignite.kafka.CacheInit;
...
//        put("STUDENT", "date>'2018-10-01' and date<'2018-11-01'");
     ...
     * 导数线程池
     */
    public static ExecutorService DATA_POOL = new ThreadPoolExecutor(8,
            16, 2L, TimeUnit.SECONDS,
